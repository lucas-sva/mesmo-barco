        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
          ...
          {ninjaInView && (
            <button
              type="button"
              onClick={jumpToNinja}
              className="inline-flex min-h-8 shrink-0 items-center rounded-md border border-line bg-paper-2/95 px-2 py-1 text-[11px] font-medium text-ink-soft hover:border-sea/50 hover:text-ink"
            >
              encontrar o Ninja
            </button>
          )}
